...
public class F26_LetterPuzzleMinigame : MinigameBehavior
{
    /// <summary>
    ...
    private void Start()
    {
        ...
        puzzleMinigame.GetComponent<F26_DragManager>().OnCompleted += HandleCompleted;
        //registers HandleCompleted as a listener for the OnCompleted event on the F26_DragManager.
        //When F26_DragManager raises OnCompleted, HandleCompleted method will be invoked.
    ...
    public void Continue()
    {
        ...
        //{
            ...
            puzzleMinigame.GetComponent<F26_DragManager>().Reset();
        ...
        Debug.Log("Next minigame called");
            F26_GameManager.Instance.CurrentMemoryManager.NextMinigame();
    ...
    //    ppVolume = Camera.main.gameObject.GetComponent<PostProcessVolume>();
        ...
        F26_Draggable[] pieceList = puzzleMinigame.GetComponent<F26_DragManager>().CreateDragToTarget(
            count,
            piecePrefab,
            targetPrefab,
            dragPos,
        ...
        if  (pieceList.Length > 0)
        {
            ...
            //{
            //    pieceList[i].GetComponent<Draggable>().originParent = puzzleMinigame.GetComponent<F26_DragManager>();
        ...
        //if (F26_GameManager.Instance.difficulty > 1)
        //{
        //    ppVolume.enabled = true;
        //    ppVolume.weight = 1;
        //    if (F26_GameManager.Instance.difficulty >= 2)
        //    { //Scales from 2 to 11
        //        ppVolume.weight = 0.45f + (F26_GameManager.Instance.difficulty * 0.05f);
        //    }
        //}
    }
